...
//        HelpItem(title: "Can I use this app as a to do list? A household finances app?", text: "Why not? This is obviously not the main focus of this app but nothing hinders you from creative repurposing. You can for example combine normal shopping items with items that act as tasks or reminders. Or have lists with the items that represent the fixed costs in you home, like electricity or rent, and move them to the inventory - maybe a different one than your main inventory - to have a more complete overview of the overall expenses."),
    ...
    private static var helpItemsDE = [
        ...
        HelpItem(title: "Wie ist der Bericht zu verstehen?", text: "Das Säulendiagramm zeigt dir deine monatliche Ausgaben seitdem du angefangen hast, die App zu benutzen. 'Monatlicher Durchschnitt' ist der Durchschnitt von deinen Ausgeben in den Monaten wo du die App benutzt hast. 'Monatstagesdurchschnitt' ist der täglicher Durchschnitt von dem was du in diesem Monat ausgegeben hast. 'Gesch. Gesamtausgaben akt. Monat' ist die Schätzung von dem, was du in diesem Monat ausgeben wirst, anhand dessen was du bislang in diesem Monat ausgegeben hast. Wenn du eie Säule antippst kommst du zur Detail-Ansicht für das jeweilige Monat. Da findest du ein Tortendiagramm mit den Kategorien wofür du am meisten ausgegeben hast und darunter ein Aggregat von den gekauften Produkten."),
