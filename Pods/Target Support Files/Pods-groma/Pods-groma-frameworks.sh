...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyBeaver-iOS9.0/SwiftyBeaver.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Valet-iOS9.0/Valet.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Reachability-iOS10.0/Reachability.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyBeaver-iOS10.0/SwiftyBeaver.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Valet-iOS10.0/Valet.framework"
fi
