//
//  AggrByDateTableViewController.swift
//  shoppin
//
...
class AggrByDateTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return monthYearAggregate?.monthYearAggregates.count ?? 0
    }

    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("aggrDateCell", forIndexPath: indexPath) as! AggrByDateTableViewCell
