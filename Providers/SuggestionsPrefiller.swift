...
//        flatBlue: 5065a0
//        flatGreen: 2ecc70
//        flatGreenDark: 26ad5e
//        flatRedDark: bf382a
//        flatPowderBlue: b8c9f2
//        flatTeal: 3a7082
//        flatGray: 95a4a5
//        flatBrown: 5e4433
//        flatForestGreen: 335e40
//        flatBlueDark: 394c82
//        flatMagenta: 9a58b5
//        flatWhiteDark: bcc2c6
//        flatBlueDark: 394c82
//        flatSandDark: d6c295
//        flatBlue.lighten(byPercentage: 0.5): 7fa1ff
//        flatPurpleDark: 5b47a3
//        flatMint: 1abc9c
//        flatMintDark: 16a085
//        flatBlack: 2b2b2b
//        flatMaroon: 773029
//        flatYellowDark: ffaa00
//        flatPink: f47cc4
//        flatBrown: 5e4433
//        flatYellow: ffcc02
//        flatRedDark: bf382a
...
//        flatPlum: 5e335e
//        flatOrange: e57d22
//        flatOrangeDark: d35400
//        flatWatermelonDark: d85458
//        flatNavyBlueDark: 2b3d4f

        let fruitsCat = ProductCategory(uuid: uuid, name: tr("pr_fruits", lang), color: "e84d3c")
        let frozenFruitsCat = ProductCategory(uuid: uuid, name: tr("pr_fruits_frozen", lang), color: "5065a0")
        let vegetablesCat = ProductCategory(uuid: uuid, name: tr("pr_vegetables", lang), color: "2ecc70")
        let herbsCat = ProductCategory(uuid: uuid, name: tr("pr_herbs", lang), color: "26ad5e")
        let meatCat = ProductCategory(uuid: uuid, name: tr("pr_meat", lang), color: "bf382a")
        let petsCat = ProductCategory(uuid: uuid, name: tr("pr_pets", lang), color: "b8c9f2")
        let bakeryCat = ProductCategory(uuid: uuid, name: tr("pr_bakery", lang), color: "3a7082")
        let riceCat = ProductCategory(uuid: uuid, name: tr("pr_rice", lang), color: "95a4a5")
        let nutsCat = ProductCategory(uuid: uuid, name: tr("pr_nuts", lang), color: "5e4433")
        let oilCat = ProductCategory(uuid: uuid, name: tr("pr_oil", lang), color: "335e40")
        let clothesCat = ProductCategory(uuid: uuid, name: tr("pr_clothes", lang), color: "394c82")
        let cleaningCat = ProductCategory(uuid: uuid, name: tr("pr_cleaning", lang), color: "9a58b5")

        let milkCat = ProductCategory(uuid: uuid, name: tr("pr_milk", lang), color: "bcc2c6")

        let fishCat = ProductCategory(uuid: uuid, name: tr("pr_fish", lang), color: "394c82")
        let pastaCat = ProductCategory(uuid: uuid, name: tr("pr_pasta", lang), color: "d6c295")
        let drinksCat = ProductCategory(uuid: uuid, name: tr("pr_drinks", lang), color: "7fa1ff")
        let alcoholCat = ProductCategory(uuid: uuid, name: tr("pr_alcohol", lang), color: "5b47a3")
        let hygienicCat = ProductCategory(uuid: uuid, name: tr("pr_hygienic", lang), color: "1abc9c")
        let dipsCat = ProductCategory(uuid: uuid, name: tr("pr_dips", lang), color: "16a085")
        let spicesCat = ProductCategory(uuid: uuid, name: tr("pr_spices", lang), color: "2b2b2b")
        let friedCat = ProductCategory(uuid: uuid, name: tr("pr_fried", lang), color: "773029")
        let breadCat = ProductCategory(uuid: uuid, name: tr("pr_bread", lang), color: "ffaa00")
        let sweetsCat = ProductCategory(uuid: uuid, name: tr("pr_sweets", lang), color: "f47cc4")
        let teaAndCoffeeCat = ProductCategory(uuid: uuid, name: tr("pr_tea_coffee", lang), color: "5e4433")
        let cheeseCat = ProductCategory(uuid: uuid, name: tr("pr_cheese", lang), color: "ffcc02")
        let beansCat = ProductCategory(uuid: uuid, name: tr("pr_beans", lang), color: "bf382a")
        let eggsCat = ProductCategory(uuid: uuid, name: tr("pr_eggs", lang), color: "33495e")
        let spreadCat = ProductCategory(uuid: uuid, name: tr("pr_spread", lang), color: "5e335e")
        let cerealCat = ProductCategory(uuid: uuid, name: tr("pr_cereal", lang), color: "e57d22")
        let coldCutCat = ProductCategory(uuid: uuid, name: tr("pr_cold_cut", lang), color: "d35400")
        let ovenCat = ProductCategory(uuid: uuid, name: tr("pr_oven", lang), color: "d85458")
        let stationeriesCat = ProductCategory(uuid: uuid, name: tr("pr_stationeries", lang), color: "2b3d4f")
