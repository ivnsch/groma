...
//        flatNavyBlueDark: 2b3d4f
        ...
        let vegetablesCat = ProductCategory(uuid: uuid, name: tr("pr_vegetables", lang), color: "2E9E3F")
        ...
        let petsCat = ProductCategory(uuid: uuid, name: tr("pr_pets", lang), color: "4169E1")
        ...
        let milkCat = ProductCategory(uuid: uuid, name: tr("pr_milk", lang), color: "444444")

        let fishCat = ProductCategory(uuid: uuid, name: tr("pr_fish", lang), color: "394c82")
        let pastaCat = ProductCategory(uuid: uuid, name: tr("pr_pasta", lang), color: "FD3F92")
        ...
        let breadCat = ProductCategory(uuid: uuid, name: tr("pr_bread", lang), color: "9b870c")
