...
public class DBSection: DBSyncable {
...
//    let listItems = RealmSwift.List<String>()
    ...
    public convenience init(uuid: String, name: String, bgColorHex: String, list: List, todoOrder: Int, doneOrder: Int, stashOrder: Int, lastUpdate: Date = Date(), lastServerUpdate: Int64? = nil, removed: Bool = false) {
    ...
    public convenience init(uuid: String, name: String, bgColorHex: String, list: List, order: ListItemStatusOrder, lastServerUpdate: Int64? = nil, removed: Bool = false) {
