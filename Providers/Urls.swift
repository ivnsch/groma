...
struct Urls {
    ...
    fileprivate static let host: String = "http://\(hostIPPort)/"
    ...
    static let updateListItemStatus = host + "listItem/ups"
    static let updateAllListItemsStatus = host + "listItems/ups"
    ...
    static let buyCart = host + "listItems/done/buy"
    ...
    // Inventory item without history
    static let inventoryItemsNoHistory = host + "inventoryItems/nh"
    ...
    static let brand = host + "product/brand"
