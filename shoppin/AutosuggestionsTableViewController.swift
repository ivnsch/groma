...
class AutosuggestionsTableViewController: UITableViewController {
...
//        self.tableView.sizeToFit()
        ...
        let v = self.tableView
        let shadowPath = UIBezierPath(rect: v.bounds)
        v.layer.masksToBounds = false
        v.layer.shadowColor = UIColor.blackColor().CGColor
        v.layer.shadowOffset = CGSizeMake(0.0, 5.0)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let option:String = filteredOptions[indexPath.row]
