...
extension UIStoryboard {
    ...
    class func mainTabController() -> MyTabBarController {
        return mainStoryboard().instantiateViewController(withIdentifier: "MainTabController") as! MyTabBarController
    }
...
//    }
    ...
    class func ingredientsController() -> IngredientsControllerNew {
        return ingredientsStoryboard().instantiateViewController(withIdentifier: "IngredientsController") as! IngredientsControllerNew
    }
    ...
    // MARK: SelectIngredientDataController
    ...
    class func manageDatabaseController() -> ManageDatabaseController {
        return manageDatabaseStoryboard().instantiateViewController(withIdentifier: "ManageDatabaseController") as! ManageDatabaseController
    }
    
    class func manageItemsAccordionController() -> ManageItemsAccordionController {
        return manageItemsAccordionStoryboard().instantiateViewController(withIdentifier: "ManageItemsAccordionController") as! ManageItemsAccordionController
    }
    ...
    class func manageBrandsController() -> ManageItemsBrandsController {
        return manageBrandsStoryboard().instantiateViewController(withIdentifier: "ManageItemsBrandsController") as! ManageItemsBrandsController
    }
