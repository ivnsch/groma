...
// Change by Ivan - expose authToken, we need exp date outside (as method because required less changes than changing scope of the property)
- (PhAuthenticationToken *) authenticationToken;
