...
class RemotePullProvider {
    ...
    func pullListProducs(_ listUuid: String, srcUser: DBSharedUser, _ handler: @escaping (RemoteResult<RemoteListItems>) -> Void) {
    ...
    func pullInventoryProducs(_ inventoryUuid: String, srcUser: DBSharedUser, _ handler: @escaping (RemoteResult<RemoteProductsWithDependencies>) -> Void) {
